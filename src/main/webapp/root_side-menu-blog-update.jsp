    ...
    <body class="app">
        ...
        <div class="flex">
                ...
                <ul>
					...
					<li>
					    <a href="root_side-menu-blog-crud-form.jsp" class="side-menu side-menu--active">
					        <div class="side-menu__icon"> <i data-feather="edit"></i> </div>
					        <div class="side-menu__title"> Blog修改 </div>
					    </a>
					</li>
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="root_index.jsp" class="">主页</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Blog修改</a> </div>
                    <!-- END: Breadcrumb -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-6">
                        <!-- BEGIN: Form Layout -->
						<form action="big_blog_Upd" method="post" enctype="multipart/form-data">
                        <div class="intro-y box p-5">
                        
                            <div>
                                <label>第一标题</label>
                                <input type="hidden" class="input w-full border mt-2"  name="blog_id" value="${param.blog_id }">
                                <input type="text" class="input w-full border mt-2"  name="blog_frist_title" value="${param.blog_frist_title }">
                            </div>
                            <div class="mt-3">
                                <label>副标题（简介）</label>
                                <input type="text" class="input w-full border mt-2" name="blog_second_title" value="${param.blog_second_title }" >
                            </div>
                            
							<div class="mt-3">
                                <label>内容（第1部分）</label>
                               	<textarea rows="" cols="" class="input h-48 w-full border mt-2"  name="blog_context1" >${param.blog_context1 }</textarea>
                            </div>
                            <div class="mt-3">
                                <label>内容（第2部分）</label>
                                <textarea rows="" cols="" class="input h-48 w-full border mt-2" name="blog_context2" >${param.blog_context2 }</textarea>
                            </div>
                            
							<div class="mt-3">
                                <label>着重突出标题</label>
                                <input type="text" class="input w-full border mt-2" name="blog_blod_context"  value="${param.blog_blod_context }" >
                            </div>
                            <div class="mt-3">
                                <label>内容（第3部分）</label>
                                <textarea rows="" cols="" class="input h-48 w-full border mt-2" name="blog_context3" >${param.blog_context3 }</textarea>
                            </div>
                            <div class="mt-3">
                                <label>意味深长的话</label>
                                <input type="text" class="input w-full border mt-2" name="blog_say"  value="${param.blog_say }" >
                            </div>
                            <div class="mt-3">
                                <label>内容（第4部分）</label>
                                <textarea rows="" cols="" class="input h-48 w-full border mt-2" name="blog_context4" >${param.blog_context4 }</textarea>
                            </div>
                             <div class="mt-3">
                                <label>内容（第5部分）</label>
                                <textarea rows="" cols="" class="input h-48 w-full border mt-2" name="blog_context5" >${param.blog_context5 }</textarea>
                            </div>
                            <div class="mt-3">
