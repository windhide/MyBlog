                ...
                <ul>
                	...
                	<li>
					    <a href="root_resume" class="side-menu side-menu--active">
					        ...
					        <div class="side-menu__title"> 教育背景添加 </div>
					    </a>
					</li>         
					<!-- Data List -->
					<li>
            ...
            <div class="content">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-6">
                        <!-- BEGIN: Form Layout -->
						<form action="root_eduadd" method="post" enctype="multipart/form-data">
                        <div class="intro-y box p-5">
                            <div>
                                <label>学校名称</label>
                                <input type="text" class="input w-full border mt-2"  name="edu_bigcontext" >
                            </div>
                            ...
                            <div class="mt-3">
                                <label>描述</label>
                                <input type="text" class="input w-full border mt-2" name="edu_context" >
                            </div>
