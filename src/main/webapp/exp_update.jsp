    ...
    <body class="app">
        ...
        <div class="flex">
                ...
                <ul>
                	...
                	<li>
					    <a href="root_resume" class="side-menu side-menu--active">
					        ...
					        <div class="side-menu__title"> 工作经历修改 </div>
					    </a>
					</li>         
					<!-- Data List -->
					<li>
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="root_index.jsp" class="">主页</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">工作经历修改</a> </div>
                    <!-- END: Breadcrumb -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-6">
                        <!-- BEGIN: Form Layout -->
						<form action="root_expupd" method="post" enctype="multipart/form-data">
                        <div class="intro-y box p-5">
                            <div>
                                <label>工作地</label>
                                <input type="hidden" class="input w-full border mt-2"  name="id" value="${param.id }" >
                                <input type="text" class="input w-full border mt-2"  name="exp_bigcontext" value="${param.exp_bigcontext }" >
                            </div>
                            ...
                            <div class="mt-3">
                                <label>描述</label>
                                <input type="text" class="input w-full border mt-2" name="exp_context"  value="${param.exp_context }" >
                            </div>
