        ...
        <div class="flex">
            ...
            <nav class="side-nav">
                ...
                <ul>
                    ...
                    <!-- Blog Form -->
					<li>
					    <a href="root_side-menu-light-crud-form.jsp" class="side-menu side-menu--active">
					        <div class="side-menu__icon"> <i data-feather="edit"></i> </div>
					        <div class="side-menu__title"> 作品修改 </div>
					    </a>
					</li>
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="root_index.jsp" class="">主页</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">作品修改</a> </div>
                    <!-- END: Breadcrumb -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-6">
                        <!-- BEGIN: Form Layout -->
						<form action="root_data_list_update" method="post" enctype="multipart/form-data">
                        <div class="intro-y box p-5">
                            <div>
                                <label>标题</label>
                                <input type="hidden" name="id" value="${param.id }">
                                <input type="text" class="input w-full border mt-2" placeholder="标题" name="work_title" value="${param.work_title }">
                            </div>
                            ...
                            <div class="mt-3">
                                <label>选择分类</label>
                                <div class="mt-2">
                                    <select data-placeholder="选择分类" class="tail-select w-full" name="worktypeid">
                                        <option value="1" ${param.worktypeid==1?"checked":""}>校园</option>
                                        <option value="2" ${param.worktypeid==2?"checked":""}>创意</option>
                                        <option value="3" ${param.worktypeid==3?"checked":""}>生活</option>
                                        <option value="4" ${param.worktypeid==4?"checked":""}>获奖</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="text-right mt-5">
								...
								<input type="submit" class="button w-24 bg-theme-1 text-white"  value="更新"/>
                            </div>
						</form>
						<!-- End: Form -->
                        </div>
