...
<head>
    ...
    <body class="app">
        ...
        <div class="flex">
            ...
            <nav class="side-nav">
                ...
                <ul>
					...
					<!-- Data List -->
					<li>
					    <a href="root_data_list" class="side-menu side-menu--active">
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="root_index.jsp" class="">主页</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">作品管理</a> </div>
                    <!-- END: Breadcrumb -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
                        <a href="root_side-menu-light-crud-form.jsp"><button class="button text-white bg-theme-1 shadow-md mr-2">添加作品</button></a>  
                    </div>
                    <!-- BEGIN: Data List -->
                        ...
                        <table class="table table-report -mt-2">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center whitespace-no-wrap">分类</th>
                            ...
                            <tbody>
                               ...
                               <c:forEach items="${data_list }" var="rdl">
                               	...
                               	<tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-64 h-32 image-fit zoom-in">
                                                <img alt="Midone Tailwind HTML Admin Template" class="tooltip " src="${rdl.imgsrc }" title="图片">
                                            </div>
                                            
                                        </div>
                                    </td>
                                    <td>
                                        <a href="" class="font-medium whitespace-no-wrap">${rdl.work_title }</a>
                                    </td>
                                    <td class="text-center">${rdl.typename }</td>
                                    <td class="w-40"></td>
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            <a class="flex items-center mr-3" href="root_side-menu-light-crud-form_update.jsp?id=${rdl.id }&work_title=${rdl.work_title }"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> 编辑 </a>
                                            <a class="flex items-center text-theme-6" href="javascript:fz(${rdl.id });" data-toggle="modal" data-target="#delete-confirmation-modal"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> 删除 </a>
                                        </div>
                                    </td>
                                </tr>
		...
		function ok(){
			window.location.href="root_data_list_delete?id="+id;
		}
